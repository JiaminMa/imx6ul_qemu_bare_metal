...
#define USDHC_INT_STATUS_EN_DMAESEN_MASK (1UL << USDHC_INT_STATUS_EN_DEBESEN_SHIFT)
...
#define USDHC_INT_SIGNAL_EN_RTEIEN_SHIFT 13UL
#define USDHC_INT_SIGNAL_EN_RTEIEN_MASK (1UL << USDHC_INT_SIGNAL_EN_RTEIEN_SHIFT)

#define USDHC_INT_SIGNAL_EN_TPIEN_SHIFT 12UL
#define USDHC_INT_SIGNAL_EN_TPIEN_MASK (1UL << USDHC_INT_SIGNAL_EN_TPIEN_SHIFT)
